    ...
    def addTwoNumbers(self, l1: Optional[ListNode], l2: Optional[ListNode]) -> Optional[ListNode]:
        ...
        while i<lengthl1 or j<lengthl2:  # 循环直到i和j都遍历完l1和l2链表或者i和j都大于l1和l2链表的长度
            ...
            if j<lengthl2:  # 如果j小于l2链表的长度，则将l2节点的值加到sumVal上，并将j加1，更新l2节点为l2.next节点
                ...
                j += 1
                l2 = l2.next
            unit_digit = sumVal % 10  # 计算sumVal的个位数
            tens_digit = sumVal // 10  # 计算sumVal的十位数
            p1.val += unit_digit  # 将p1节点的值加上个位数
            if p1.val >= 10:  # 如果p1节点的值大于等于10
            ...
            if i<lengthl1 or j<lengthl2 or tens_digit!= 0:  # 如果i小于l1链表的长度或者j小于l2链表的长度或者p1节点的十位数不为0
                p1.next = ListNode(tens_digit)  # 创建一个新的ListNode节点，值为十位数，并将其作为p1节点的下一个节点
