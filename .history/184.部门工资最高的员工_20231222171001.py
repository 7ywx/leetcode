...
def department_highest_salary(employee: pd.DataFrame, department: pd.DataFrame) -> pd.DataFrame:
    ...
    max_salary = employess_department.groupby('name_y')['salary'].max()
    department_highest_salary = employess_department[employess_department['salary'].isin(max_salary)].rename(columns={'name_y': 'Department','name_x': 'Employee','salary': 'Salary'})['Department','Employee','Salary']
