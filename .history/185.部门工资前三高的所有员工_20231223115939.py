...
def top_three_salaries(employee: pd.DataFrame, department: pd.DataFrame) -> pd.DataFrame:
    e_d = employee.merge(department, left_on='departmentId', right_on='id', how='left').rename(columns={'name_y': 'Department', 'name_x': 'Employee', 'salary': 'Salary'})
    print(e_d)
...
print(df)
top_three_salaries(df, Department)
